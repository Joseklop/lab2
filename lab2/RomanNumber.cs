...
internal class RomanNumber : ICloneable, IComparable
{
    ...
    public static RomanNumber Sub(RomanNumber? n1, RomanNumber? n2)
    {
        ...
        if (n1.num - n2.num >= 4000) throw new RomanNumberException("ERROR Sub-2: Result is more than 4000");
        if (n1.num <= n2.num) throw new RomanNumberException("ERROR Sub-3: A negative result");
        return new RomanNumber((ushort)(n1.num - n2.num));
    }
